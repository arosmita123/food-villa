    ...
    <div>
      <div className="w-11/12 min-h-full mx-auto flex flex-col md:flex-row justify-between mt-32 ">
        <div className="w-full md:w-1/2 ">
          ...
          {cartItems.length > 0 && (
            <button
              className="h-10 w-24  text-[#3F4255] font-semibold border-2 rounded-md px-2 hover:bg-blue-200"
        ...
        {cartItems.length > 0 && (
          <div className="w-full md:w-[30%] md:h-[500px] mt-12 md:mt-0">
            ...
            <button className="h-12 w-full bg-blue-100 rounded-md flex justify-center items-center gap-1 hover:bg-blue-200">
            ...
            <div className="text-gray-800 my-2">Gift Card/ Discount code</div>
            ...
            <div className="flex justify-between text-sm my-3">
              ...
              <p className=" text-[#948d8d]">₹700</p>
            </div>
            <div className="flex justify-between text-sm my-3">
              <p className="text-gray-600">Shipping</p>
              <p className=" text-[#948d8d]">₹62</p>
            </div>
            <div className="flex justify-between text-md my-3">
              <p className="text-gray-600 font-semibold">Total</p>
              <p className=" text-[#948d8d]font-semibold">₹762</p>
            </div>
